    ...
    <div>
      <div className="body">
        ...
        <div className="container mx-auto py-8 lg:px-32">
          <h1 className="text-3xl font-bold mb-4 px-4">Contact Me</h1>
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 max-w-4xl mx-20">
            {/* GitHub */}
            <Link href="https://github.com/dev-athar">
              <div className="flex flex-col items-center bg-black p-4 rounded-lg border-2 hover:text-primary-color transition duration-300">
                <svg
            ...
            {/* Twitter */}
            <Link href="https://twitter.com/dev_athar">
              <div className="flex flex-col items-center bg-black p-4 rounded-lg border-2 hover:text-primary-color transition duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 50 50"
            ...
            {/* Gmail */}
            <Link href="mailto:dev.athar11@gmail.com">
              <div className="flex flex-col items-center bg-black p-4 rounded-lg border-2 hover:text-primary-color transition duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 50 50"
                ...
                <h3 className="text-sm font-semibold my-2 ">
                  dev.athar11@gmail.com
                </h3>
                <p className="text-sm text-gray-600 text-center">
                  Reach out to me via email for inquiries and collaborations.
                </p>
              </div>
            </Link>
          </div>
